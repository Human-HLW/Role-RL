...
Reinforcement Learning: The program uses Q-learning to update the selection strategy for each role based on the rewards and costs of previous selections.

Board Member Election: A Markov chain-based election process is used to update the weights of the LLMs acting as board members for judging the correctness of responses.
...
bash
python main_Role_RL_comment.py
